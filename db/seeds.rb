...
jack = User.create!(username: "jack123", email: "jack@gmail.com", password: "123", first_name: "Jack", last_name: "Ling", profile_pic_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxQxB-arXxMyK7sUsJGnD9sfXNusMOghMZ2bVw7TjXWkPGDQYhjw")
holly = User.create!(username: "holly123", email: "holly@gmail.com", password: "123", first_name: "Holly", last_name: "Atkinson", profile_pic_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbpF6o3o07Gd2apIv5Kp-KBGPqhHXmBJitMXTn762SytWGno0A")
...
janine = User.create!(username: "Ja9", email: "janine@gmail.com", password: "123", first_name: "Janine", last_name: "Luk", profile_pic_url: "https://pbs.twimg.com/media/C1G1FEVXcAEW-7W.jpg")
ian = User.create!(username: "1AN", email: "ian@gmail.com", password: "123", first_name: "Ian", last_name: "Harrison", profile_pic_url: "")
dan = User.create!(username: "DanTheMan", email: "Kaczmarczyk@gmail.com", password: "123", first_name: "Holly", last_name: "Atkinson", profile_pic_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxQxB-arXxMyK7sUsJGnD9sfXNusMOghMZ2bVw7TjXWkPGDQYhjw")
...
u7 = UserCoin.create!(user: dan, coin: coin5, quantity: 100, selling: true)
u8 = UserCoin.create!(user: dan, coin: coin4, quantity: 200, selling: true)
u9 = UserCoin.create!(user: janine, coin: coin5, quantity: 100, selling: true)
u10 = UserCoin.create!(user: janine, coin: coin2, quantity: 200, selling: true)
u11 = UserCoin.create!(user: janine, coin: coin1, quantity: 100, selling: false)
u12 = UserCoin.create!(user: janine, coin: coin3, quantity: 200, selling: true)
