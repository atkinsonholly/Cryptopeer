...
u1 = UserCoin.create(user_id: 1, coin_id: 1, quantity: 5)
u2 = UserCoin.create(user_id: 1, coin_id: 2, quantity: 10)
u3 = UserCoin.create(user_id: 1, coin_id: 3, quantity: 15)
u4 = UserCoin.create(user_id: 2, coin_id: 1, quantity: 12)
u5 = UserCoin.create(user_id: 2, coin_id: 2, quantity: 20)
u6 = UserCoin.create(user_id: 2, coin_id: 3, quantity: 5)
